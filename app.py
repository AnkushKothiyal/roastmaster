...
# User input
situation = st.text_area("Describe your situatioAIzaSyCq1VdjVJNCgaIia16nUquJnsVW0QiOdsAn:", placeholder="While going to office I was having an icecream and it fell down")
